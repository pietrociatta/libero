...
export default async function handler(req, res) {
  ...
  const credentials = {
    ...
    client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/servizio%40fraud-recovery.iam.gserviceaccount.com",
    universe_domain: "googleapis.com",
  };

  const writeToSheet = async (data) => {
    const SPREADSHEET_ID = "152w1kZoKyMOqowh6uf7TMzCdqJWb8cxLDFMzfcuznG0";
  ...
  try {
    ...
    // Get current date and time in Italy's timezone
